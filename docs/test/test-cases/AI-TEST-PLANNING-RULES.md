...
- **Đóng quyết định đã chốt thành acceptance criterion:** Trước khi ghi `Partial`, `FAIL`, “cần Product chốt” hoặc một expected result tự đề xuất, phải đối chiếu nguồn chốt — gồm mockup `claude-design` đã phê duyệt, decision record và issue/PR được viện dẫn trong plan. Nếu nguồn này quy định hành vi dứt khoát, chuyển nó thành expected result có dẫn chứng; không mở lại tranh luận chỉ vì UC/tài liệu cũ không lặp lại cùng quyết định.
