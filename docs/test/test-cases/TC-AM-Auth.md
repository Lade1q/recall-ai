...
| **Độ ưu tiên**           | High                                                                                                                                                                                                                                                                                                                     |
| **Điều kiện tiên quyết** | - Server đang chạy tại `http://localhost:3000`<br>- Database test đang kết nối<br>- Email `newuser@example.com` chưa tồn tại trong DB                                                                                                                                                                                    |
...
| **Dữ liệu đầu vào**      | Test với các giá trị email không hợp lệ sau (chạy riêng từng case):<br>• `"notanemail"` _(không có @)_<br>• `"missing@"` _(thiếu domain)_<br>• `"@nodomain.com"` _(thiếu local part)_<br>• `"spaces in@email.com"` _(có khoảng trắng)_<br>Password và Name dùng giá trị hợp lệ. |
...
| **Kết quả thực tế**      | _(điền sau khi test)_                                                                                                                                                                                                                                                           |
| **Trạng thái**           | Not Run                                                                                                                                                                                                                                                                         |
| **Ghi chú**              | Chạy lần lượt từng email invalid và ghi lại kết quả riêng.                                                                                                                                                                                                                      |
...
| **Dữ liệu đầu vào**      | Case A — Thiếu `email`: `{ "password": "SecurePass1", "name": "Test" }`<br>Case B — Thiếu `password`: `{ "email": "test@example.com", "name": "Test" }`<br>Case C — Thiếu `name`: `{ "email": "test@example.com", "password": "SecurePass1" }`<br>Case D — Body rỗng: `{}` |
...
| **Kết quả thực tế**      | _(điền sau khi test)_                                                                                                                                                                                                                                                      |
| **Trạng thái**           | Not Run                                                                                                                                                                                                                                                                    |
| **Ghi chú**              | Mỗi sub-case nên được log riêng nếu có kết quả khác nhau.                                                                                                                                                                                                                  |
...
| **Dữ liệu đầu vào**      | `email: "spacepass@example.com"`<br>`password: "        "` _(8 space characters)_<br>`name: "Space Test"`                                                           |
| **Kết quả mong đợi**     | - HTTP Status: **400 Bad Request** _(nên reject)_<br>- Hoặc nếu hệ thống chấp nhận: cần ghi nhận và đánh giá risk bảo mật                                           |
| **Kết quả thực tế**      | _(điền sau khi test)_                                                                                                                                               |
| **Trạng thái**           | Not Run                                                                                                                                                             |
| **Ghi chú**              | Đây là exploratory / edge case test. Nếu hệ thống accept → tạo bug report về security weakness.                                                                     |
...
| **Kết quả thực tế**      | _(điền sau khi test)_                                                                                                                                                                                                                                            |
| **Trạng thái**           | Not Run                                                                                                                                                                                                                                                          |
| **Ghi chú**              | **Lưu accessToken** từ response để dùng trong TC-AM-02-04, TC-AM-02-07.                                                                                                                                                                                          |
...
| **Kết quả thực tế**      | _(điền sau khi test)_                                                                                                                                                                                                                                         |
| **Trạng thái**           | Not Run                                                                                                                                                                                                                                                       |
| **Ghi chú**              | Security check: message lỗi phải giống hệt TC-AM-02-03 để ngăn User Enumeration.                                                                                                                                                                              |
...
| **Kết quả thực tế**      | _(điền sau khi test)_                                                                                                                                                                                                              |
| **Trạng thái**           | Not Run                                                                                                                                                                                                                            |
| **Ghi chú**              | **Critical Security Check:** So sánh message của TC-AM-02-02 và TC-AM-02-03 — chúng phải **giống nhau hoàn toàn** để ngăn User Enumeration Attack.                                                                                 |
...
| **Dữ liệu đầu vào**      | Header: `Authorization: Bearer eyJhbGciOiJIUzI1NiJ9...` _(expired token)_                                                                                                 |
...
| **Kết quả thực tế**      | _(điền sau khi test)_                                                                                                                                                     |
| **Trạng thái**           | Not Run                                                                                                                                                                   |
| **Ghi chú**              | Cách tạo expired token để test: (1) Đợi 15 phút sau khi login. (2) Hoặc dùng jwt.io để tạo token với `exp` trong quá khứ và sign bằng secret key môi trường test.         |
...
| **Kết quả thực tế**      | _(điền sau khi test)_                                                                                                                                                                                                                                               |
| **Trạng thái**           | Not Run                                                                                                                                                                                                                                                             |
| **Ghi chú**              | Dùng `accessToken` mới từ TC này để gọi lại `GET /api/v1/auth/me` — phải trả về 200.                                                                                                                                                                                |
...
| **Dữ liệu đầu vào**      | Case A — Token giả: `{ "refreshToken": "invalid.token.string" }`<br>Case B — Token hết hạn (7 ngày): _(dùng expired refresh token)_<br>Case C — Thiếu trường: `{}`                              |
| **Kết quả mong đợi**     | Mỗi case:<br>- HTTP Status: **401 Unauthorized**<br>- `"success": false`<br>- `error.code` = `"UNAUTHORIZED"`<br>- `error.message` = `"Invalid or expired refresh token"`                       |
| **Kết quả thực tế**      | _(điền sau khi test)_                                                                                                                                                                           |
| **Trạng thái**           | Not Run                                                                                                                                                                                         |
| **Ghi chú**              | —                                                                                                                                                                                               |
...
| **Độ ưu tiên**           | Medium                                                                                                                                                                                                  |
| **Điều kiện tiên quyết** | - Server đang chạy<br>- Có valid `accessToken` từ TC-AM-02-01                                                                                                                                           |
...
| **Dữ liệu đầu vào**      | Case A — Thiếu "Bearer": `Authorization: <token>` _(không có prefix Bearer)_<br>Case B — Sai prefix: `Authorization: Token <valid_token>`<br>Case C — Token giả: `Authorization: Bearer fake.token.xyz` |
...
| ----------- | -------- | ------------------------------------------------ | ------------------------ | ---------- | -------------- | ---------- |
| TC-AM-01-01 | UC-01    | Register thành công với dữ liệu hợp lệ           | Functionality            | High       | Happy          | Not Run    |
| TC-AM-01-02 | UC-01    | Register thất bại — Email đã tồn tại (409)       | Functionality / Database | High       | Negative       | Not Run    |
| TC-AM-01-03 | UC-01    | Register thất bại — Password < 8 ký tự (400)     | Functionality            | High       | Negative       | Not Run    |
| TC-AM-01-04 | UC-01    | Register thất bại — Email format sai (400)       | Functionality            | High       | Negative       | Not Run    |
| TC-AM-01-05 | UC-01    | Register thất bại — Thiếu trường bắt buộc (400)  | Functionality            | Medium     | Negative       | Not Run    |
| TC-AM-01-06 | UC-01    | Register thất bại — `name` < 2 ký tự (400)       | Functionality            | Medium     | Negative       | Not Run    |
| TC-AM-01-07 | UC-01    | Register thành công — Validate response schema   | Interface / Security     | High       | Happy          | Not Run    |
| TC-AM-01-08 | UC-01    | Register thất bại — Password chỉ là khoảng trắng | Security                 | Medium     | Negative       | Not Run    |
| TC-AM-02-01 | UC-02    | Login thành công với dữ liệu hợp lệ              | Functionality            | High       | Happy          | Not Run    |
| TC-AM-02-02 | UC-02    | Login thất bại — Sai password (401)              | Functionality / Security | High       | Negative       | Not Run    |
| TC-AM-02-03 | UC-02    | Login thất bại — Email không tồn tại (401)       | Functionality / Security | High       | Negative       | Not Run    |
| TC-AM-02-04 | UC-02    | Protected route — Không có token (401)           | Security                 | High       | Negative       | Not Run    |
| TC-AM-02-05 | UC-02    | Protected route — Token hết hạn (401)            | Security                 | High       | Negative       | Not Run    |
| TC-AM-02-06 | UC-02    | Login thất bại — Thiếu trường bắt buộc (400)     | Functionality            | Medium     | Negative       | Not Run    |
| TC-AM-02-07 | UC-02    | Protected route — Token hợp lệ → 200 OK          | Functionality            | High       | Happy          | Not Run    |
| TC-AM-02-08 | UC-02    | Refresh Token thành công (200)                   | Functionality            | High       | Happy          | Not Run    |
| TC-AM-02-09 | UC-02    | Refresh Token thất bại — Token sai/hết hạn (401) | Security                 | High       | Negative       | Not Run    |
| TC-AM-02-10 | UC-02    | Protected route — Sai định dạng Bearer (401)     | Security                 | Medium     | Negative       | Not Run    |

**Tổng cộng:** 18 test cases | Happy Path: 5 | Negative: 13
