...
| TC-AM-02-08    | UC-02    | Refresh Token thành công (200)                            | Functionality            | High       | Happy          | ⚠️ Pass (lưu ý assertion) |
...
**Tổng cộng:** 18 test cases gốc → **29 requests** (do tách sub-cases) | Happy Path: 5 | Negative: 13 | **Pass: 27** | **Fail: 1 (Bug)** | **Warning: 1**
