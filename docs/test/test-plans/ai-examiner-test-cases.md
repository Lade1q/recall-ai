...
| **Các bước thực hiện**   | 1. Nhận câu hỏi về khái niệm hiện tại.<br>2. Nhập và gửi câu trả lời sai hoàn toàn ở lượt 1.<br>3. Xác nhận hệ thống không đóng khái niệm mà thu hẹp chính câu hỏi vừa sai thành câu gợi ý ở lượt 2.<br>4. Không dùng hoặc chép nội dung đáp án có thể xuất hiện trong feedback; tiếp tục nhập câu trả lời sai hoàn toàn ở lượt 2.<br>5. Xác nhận hệ thống thu hẹp chính câu hỏi đó thêm một lần ở lượt 3.<br>6. Tiếp tục trả lời sai hoàn toàn ở lượt 3 để đi hết thang gợi ý.<br>7. Kiểm tra kết quả chốt khái niệm, `mastery_score`, traceback và hàng đợi ôn. |
| **Dữ liệu đầu vào**      | Ba câu trả lời cố ý sai hoàn toàn cho cùng câu hỏi và hai lần thu hẹp; người kiểm phải trả lời sai cả 3 lượt và không dùng đáp án có thể bị lộ trong feedback.                                                                                                                                                                                                                                                                                                                                                                                                    |
| **Kết quả mong đợi**     | - Sau lượt sai đầu tiên, hệ thống thu hẹp chính câu hỏi đó và hỏi lại, tối đa 2 lần; hết thang hoặc chạm trần C6 (3 lượt) thì đóng khái niệm.<br>- Cả 2 lượt gợi ý vẫn được chấm và hiển thị nhưng không được tính vào `mastery_score`; với dữ liệu sai hoàn toàn, chỉ lượt 1 được tính và `mastery_score = 0.00`.<br>- Sau lượt 3, cơ chế traceback chạy và tìm thấy khái niệm tiên quyết.<br>- Khái niệm tiên quyết được xếp lịch học ngay (`scheduledFor: now`) ở đầu hàng đợi cho phiên học tiếp theo.                                                        |
| **Kết quả thực tế**      | Chạy ngày 31/08/2026 với `USE_MOCK_AI=true`, concept `Linear Search without Sentinel`: trả lời `a` ở cả 3 lượt đều nhận verdict `wrong`; lượt 2 và 3 là câu gợi ý thu hẹp. Phiên đóng ở lượt 3, ghi rõ 2 lượt gợi ý không tính vào mastery; điểm `0.15` chỉ từ lượt 1 (`0.15 × 1.0`). Điểm dưới `0.60` kích hoạt traceback và hệ thống báo xếp trước 2 khái niệm nền.                                                                                                                                                                                             |
| **Trạng thái**           | PASS (MOCK)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| **Ghi chú**              | Kịch bản này bắt buộc phải ĐẠT để được demo. Kết quả mock xác nhận state machine và luồng traceback; mock cố định `wrong = 0.15` nên không dùng để xác nhận giá trị `0.00` của lần chấm Gemini thật. Vẫn phải chạy live đủ 3 lượt trước khi chuyển trạng thái sang PASS/FAIL.                                                                                                                                                                                                                                                                                     |
| **Nhận xét**             |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| **Các bước thực hiện**   | 1. Nhận câu hỏi về khái niệm cơ sở.<br>2. Nhập và gửi câu trả lời sai hoàn toàn ở lượt 1.<br>3. Xác nhận hệ thống hỏi thêm câu thu hẹp ở lượt 2; tiếp tục trả lời sai hoàn toàn.<br>4. Xác nhận hệ thống hỏi thêm câu thu hẹp ở lượt 3; tiếp tục trả lời sai hoàn toàn.<br>5. Kiểm tra hành vi sau khi chạm trần C6.                                                                                                                      |
| **Dữ liệu đầu vào**      | Ba câu trả lời cố ý sai hoàn toàn cho cùng câu hỏi và hai lần thu hẹp; không dùng nội dung đáp án có thể xuất hiện trong feedback.                                                                                                                                                                                                                                                                                                        |
| **Kết quả mong đợi**     | - Hệ thống thu hẹp chính câu hỏi đã trả lời sai và hỏi lại tối đa 2 lần; hết thang hoặc chạm trần C6 (3 lượt) thì đóng khái niệm.<br>- Hai lượt gợi ý không được tính vào `mastery_score`; với dữ liệu sai hoàn toàn, `mastery_score = 0.00`.<br>- Không xếp thêm khái niệm qua traceback vì khái niệm không có tiên quyết.<br>- Hệ thống đưa chính khái niệm vào chế độ lặp lại ngắt quãng (spaced repetition).                          |
| **Kết quả thực tế**      | Chạy ngày 31/08/2026 với `USE_MOCK_AI=true`, concept gốc không có tiên quyết: trả lời `a` ở cả 3 lượt đều nhận verdict `wrong`; lượt 2 và 3 là câu gợi ý thu hẹp. Phiên đóng ở lượt 3, 2 lượt gợi ý không tính vào mastery và điểm `0.15` chỉ từ lượt 1. Traceback không tìm thấy tiên quyết, không có review item `traceback`; chỉ tạo một review item `spaced_repetition` cho chính concept với trạng thái `pending` và lịch tương lai. |
| **Trạng thái**           | PASS (MOCK)                                                                                                                                                                                                                                                                                                                                                                                                                               |
| **Ghi chú**              | Phát hiện khi rà toàn tệp theo #448: đây là test case thứ hai còn phụ thuộc luật cũ. Kết quả mock xác nhận state machine và spaced repetition; vẫn phải chạy Gemini thật trước khi chuyển trạng thái sang PASS/FAIL.                                                                                                                                                                                                                      |
| **Nhận xét**             |                                                                                                                                                                                                                                                                                                                                                                                                                                           |
