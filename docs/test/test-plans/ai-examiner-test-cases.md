...
| **Trạng thái**           | NOT RUN                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| **Ghi chú**              | Kịch bản này bắt buộc phải ĐẠT để được demo. Viết lại theo #448 và hướng (c) của #392. Kiểm thử hồi quy tự động cho state machine, mastery, interview service và traceback đã đạt; vẫn phải chạy live đủ 3 lượt trước khi chuyển trạng thái sang PASS/FAIL.                                                                                                                                                                                                                                                                                                       |
| **Nhận xét**             |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
